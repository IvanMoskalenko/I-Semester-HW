    ...
    testList "First Homework"
        [
            ...
            testCase "Иногда могут генерироваться два очень больших числа, для складывании которых необходимо использовать int64, а не int32 (пятая задача)" <| fun _ ->
                let subject = hw2.fifthTask [| 2147483645; 2147483644 |]
            ...
            testCase "Иногда могут генерироваться два очень больших числа, для складывании которых необходимо использовать int64, а не int32 (шестая задача)" <| fun _ ->
                let subject = hw2.sixthTask [| 1; 2; 2147483645; 2147483644; 5; 89 |] 2 3
    ...
    testList "Property tests"
        [           
            testProperty "Fib2 = Fib3" 
                <| fun (n: int) -> Expect.equal (hw3.fib2 (abs n)) (hw3.fib3 (abs n)) "Fib2 must be equal to Fib3"
            testProperty "Fib3 = Fib4" 
                <| fun (n: int) -> Expect.equal (hw3.fib3 (abs n)) (hw3.fib4 (abs n)) "Fib3 must be equal to Fib4"
            testProperty "Fib4 = Fib5" 
                <| fun (n: int) -> Expect.equal (hw3.fib4 (abs n)) (hw3.fib5 (abs n)) "Fib4 must be equal to Fib5"
        ]
